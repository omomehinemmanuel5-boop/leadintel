...
const CONNECTORS = [
  ...
  },
  {
    ...
    items: [
      ...
      { name: "SEC 10-K Item 401 officer table (US)", status: "live" as const, note: "Free, zero registration. Structurally safe — this section is guaranteed to be about the filer's own officers, not a peer comparison." },
